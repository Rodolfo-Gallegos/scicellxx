...
namespace scicellxx
{
 ...
 CCJacobianAndResidualForBackwardEuler<EQUATIONS_TYPE>::CCJacobianAndResidualForBackwardEuler()
 ...
 // ===================================================================
 template<class EQUATIONS_TYPE>
 void CCJacobianAndResidualForBackwardEuler<EQUATIONS_TYPE>::compute_jacobian()
 {
  // Get the odes
 ...
 // ===================================================================
 template<class EQUATIONS_TYPE>
 void CCJacobianAndResidualForBackwardEuler<EQUATIONS_TYPE>::compute_residual()
 {
  // Get the odes
  EQUATIONS_TYPE *odes_pt = this->odes_pt();
  // Get the time step
