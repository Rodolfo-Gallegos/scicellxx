...
namespace scicellxx
{
 ...
 CCNewtonsMethodForAdamsMoulton2<EQUATIONS_TYPE>::CCNewtonsMethodForAdamsMoulton2()
 ...
 // ===================================================================
 template<class EQUATIONS_TYPE>
 void CCNewtonsMethodForAdamsMoulton2<EQUATIONS_TYPE>::actions_before_initial_convergence_check()
 {
  // Get the odes
