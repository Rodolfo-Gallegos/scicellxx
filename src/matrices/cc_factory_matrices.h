#ifndef CCFACTORYMATRICES_H
#define CCFACTORYMATRICES_H
...
namespace scicellxx
{
 ...
 public:
  ...
  ACMatrix* create_matrix();
   
  /// Returns a matrix pointer (based on compilation options)
  ACMatrix* create_matrix(const unsigned long m, const unsigned long n);
   
  /// Returns the specified matrix pointer
  ACMatrix* create_matrix(std::string matrix_type_name);
   
  /// Returns the specified matrix pointer
  ACMatrix* create_matrix(std::string matrix_type_name, const unsigned long m, const unsigned long n);
   
  /// Returns a vector pointer (based on compilation options)
  ACVector* create_vector();
   
  /// Returns a vector pointer (based on compilation options)
  ACVector* create_vector(const unsigned long n, bool is_column_vector = true);
   
  /// Returns the specified vector pointer
  ACVector* create_vector(std::string vector_type_name);
   
  /// Returns the specified vector pointer
  ACVector* create_vector(std::string vector_type_name, const unsigned long n, bool is_column_vector = true);
...
#endif // #ifndef CCFACTORYMATRICES_H
